...
import { pdfToPowerpointDicts } from '../i18n';
import { convertPdfToPowerpoint, formatSize } from '../logic/pdfToPowerpoint';

export default function PdfToPowerpointTool() {
  const t = useToolI18n(pdfToPowerpointDicts);
  ...
  async function handleFile(f) {
    ...
    try {
      const { blob, fileName } = await convertPdfToPowerpoint(f, (current, total) => {
          ...
          <div className="pdf-ws-card">
            <div className="pdf-ws-grid">
              ...
              <div className="pdf-ws-right">
                <div className="pdf-ws-panel-label">PowerPoint Önizleme</div>
