...
import { pngToWebpDicts } from '../i18n';
import { convertPngToWebp, formatSize } from '../logic/pngToWebp';

export default function PngToWebpTool() {
  const t = useToolI18n(pngToWebpDicts);
  ...
  async function handleConvert() {
    ...
    setError('');
    try {
      const { blob, fileName, originalSize, newSize } = await convertPngToWebp(file, quality);
