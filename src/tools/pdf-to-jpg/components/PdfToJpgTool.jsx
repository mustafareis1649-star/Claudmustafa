...
import { pdfToJpgDicts } from "../i18n";
import { pdfToJpg, formatSize } from "../logic/pdfToJpg";

const LEVELS = ["low", "medium", "high"];

export default function PdfToJpgTool() {
  const t = useToolI18n(pdfToJpgDicts);
  ...
  async function handleConvert() {
    ...
    try {
      const { blob, fileName, pageCount: pc } = await pdfToJpg(file, level, (current, total) => {
